from userportal.voice_backend.synthesizer.utils.text import text_to_sequence
...
from userportal.voice_backend.synthesizer.utils import plot
from userportal.voice_backend.synthesizer import audio
